...
from app.extensions import db, migrate, jwt, cache, limiter, swagger, setup_logging
from app.exceptions import APIError, ValidationError, AuthenticationError, ForbiddenError, NotFoundError, ConflictError
...
def create_app(config_name=None):
    ...
    from app.routes.itunes import itunes_bp
